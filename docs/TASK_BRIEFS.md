...
**Depends on:** T5, T8. **Status:** Partly: schemas and `resolveConfig` done; endpoints not.
...
### T12. Run Engine (D, L)
**Depends on:** T6, T10, T11. **Status:** Partly: `idempotencyKey`, `effectiveStatus`, `assertRetryAllowed` done and tested.
