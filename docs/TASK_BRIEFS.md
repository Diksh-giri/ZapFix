...
**Depends on:** T5, T8. **Status:** In progress (2026-09-26): app catalog and owner-scoped workflow create, list, read, and version-safe update are done; time-zone behavior pending.
